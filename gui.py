...
from PyQt5.QtWidgets import QApplication, QWidget, QLabel, QMainWindow, QLineEdit, QPushButton, QVBoxLayout
import sqlite3


# TO DO
# main page interface
# three switchable widgets on main page with buttons to switch them
